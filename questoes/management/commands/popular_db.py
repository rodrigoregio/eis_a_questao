...
class Command(BaseCommand):
    ...
    disciplinas=['Português','Matemática','Química','Física','Biologia']
    bancas=['CESP','CESGRANRIO','CONSULPLAN','FCC','FGV','VUNESP','ESAF','IPAD','QUADRIX']
    anos=['2000', '2001', '2002','2003','2004','2005','2006','2007','2008','2009','2010','2011', '2012','2013','2014','2015','2016','2017','2018']
    orgaos=['TRT', 'TRF', 'TCE', 'Petrobrás', 'CGU', 'Policia Militar']
    ...
    def popular_tabela(self,objeto,lista):
        for descricao in lista:
            ...
            try:
                ...
                self.stdout.write('O registro "%s" já existe no banco de dados' % descricao)
